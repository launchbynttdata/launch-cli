...
@click.option(
    ...
    is_flag=True,
    default=False,
    help="If set, it will ignore check the diff between the pipeline and service changes.",
)
@click.option(
    "--platform-resource",
    default=None,
...
def plan(
    ...
    Args:
        ...
        check_diff (bool): If set, it will ignore check the diff between the pipeline and service changes.
