...
from launch.lib.service.common import copy_and_render_templates


@patch("launch.lib.service.common.find_dirs_to_render")
@patch("launch.lib.service.common.render_jinja_template")
